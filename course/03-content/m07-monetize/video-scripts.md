...
| 0:30 | `ListenToMe/docs/competition-analysis.md`, Price column | This is the raw material: thirteen competitor rows plus ListenToMe, dated 2026-09. Read the header convention first — where a detail could not be confirmed from a primary source, it is qualified "approximately" or "reportedly." That convention is a promise to the reader, and you copy it in the lab. |
