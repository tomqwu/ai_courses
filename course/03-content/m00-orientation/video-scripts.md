...
| 1:30 | `ListenToMe/README.md`, coverage badge | Look at this README. The badge says ninety-six percent core coverage. That is not a claim the author typed — a test run produced it. Same page: notarized DMGs on Releases. Then open `ListenToMe/docs/competition-analysis.md`: twelve rows, each with a source and a date. Positioning work done as research. |
