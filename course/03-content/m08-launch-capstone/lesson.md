...
**Length follows price.** The research guidance (§E): **800–1,200 words under $200; 2,000–3,000 words for $500+ offers or cold traffic.** Stakes are the reason — the more a reader pays and the less they know you, the more questions the page must answer. The course's page runs ~1,900 words of copy (2,251 with its authoring notes) for a $399–$1,490 cold-traffic offer — at the lower end of the 2,000–3,000 band, and deliberately so, because a free lead product carries the top-of-funnel education (`04-sales/landing-page.md`). "Longer pages always convert better" is false in both directions: 2,500 words for a $49 product pads and dilutes; 800 words for a $1,490 cohort leaves the objection teardown unanswered. Set the word target from the price before drafting.
